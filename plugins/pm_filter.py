    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            try:
                ...
                await query.answer("You are using this for one of my old message, please retry your request.",show_alert=True)
                return
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('My Owner', url='https://t.me/joel_boban'),
